-- Based on basecamp/omarchy default/hypr/require_all.lua with Fedory command and path names.
-- Require every *.lua file in a directory in sorted order.
-- Used for Fedory extension-style folders such as default/hypr/apps,
-- default/hypr/bindings, and ~/.local/state/fedory/toggles/hypr.
