-- Based on basecamp/omarchy default/hypr/bindings/tiling.lua with Fedory command and path names.
o.bind("SUPER + W", "Close window", hl.dsp.window.close())
o.bind("CTRL + ALT + DELETE", "Close all windows", "fedory-hyprland-window-close-all")

o.bind("SUPER + J", "Toggle window split", hl.dsp.layout("togglesplit"))
o.bind("SUPER + P", "Pseudo window", hl.dsp.window.pseudo())
o.bind("SUPER + T", "Toggle window floating/tiling", hl.dsp.window.float({ action = "toggle" }))
o.bind("SUPER + F", "Full screen", hl.dsp.window.fullscreen({ mode = "fullscreen" }))
o.bind("SUPER + CTRL + F", "Tiled full screen", "fedory-hyprland-window-tiled-fullscreen-toggle")
o.bind("SUPER + ALT + F", "Full width", hl.dsp.window.fullscreen({ mode = "maximized" }))
o.bind("SUPER + O", "Pop window out (float & pin)", "fedory-hyprland-window-pop")
o.bind("SUPER + ALT + Home", "Save window width", "fedory-hyprland-window-width save")
o.bind("SUPER + Home", "Restore window width", "fedory-hyprland-window-width restore")
o.bind("SUPER + L", "Toggle workspace layout", "fedory-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + SLASH", "Monitor scaling up", "fedory-hyprland-monitor-scaling up")
o.bind("SUPER + ALT + SLASH", "Monitor scaling down", "fedory-hyprland-monitor-scaling down")
