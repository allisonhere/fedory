-- Based on basecamp/omarchy default/hypr/bindings/clipboard.lua with Fedory command and path names.
...
-- layer-shell surfaces such as Fedory panels. A virtual keyboard (wtype) won't
...
o.bind("SUPER + CTRL + V", "Clipboard manager", "fedory-shell shell toggle fedory.clipboard")
