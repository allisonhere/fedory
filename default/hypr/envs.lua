-- Based on basecamp/omarchy default/hypr/envs.lua with Fedory command and path names.
local paths = require("default.hypr.paths")
local require_optional = require("default.hypr.require_optional")

-- GUM environment variables for styling purposes.
require_optional.module("fedory.current.theme.gum_env")
...
hl.env("FEDORY_PATH", paths.fedory_path)

local bin_dir = paths.fedory_path .. "/bin"
local kept = {}
