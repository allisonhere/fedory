...
// Visual reference + live playground for fedory-shell's common UI
// components. Summon with `fedory dev ui-preview`, or directly via:
//   fedory-shell shell summon fedory.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `fedory dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("fedory.dev-gallery")
  ...
  FloatingWindow {
    id: window
    title: "Fedory shell – dev gallery"
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("fedory.dev-gallery")
    }
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `fedory font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["fedory.clock", "fedory.weather", "fedory.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "fedory.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "fedory-menu", label: "Fedory menu", description: "Launcher / system menu" },
