...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "fedory-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("fedory polkit agent registered")
      else console.warn("fedory polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "fedory-polkit"
