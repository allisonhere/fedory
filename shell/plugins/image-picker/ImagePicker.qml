...
Item {
  ...
  // Injected by fedory-shell; defaults to the session FEDORY_PATH.
  property string fedoryPath: Quickshell.env("FEDORY_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("FEDORY_IMAGE_SELECTOR_DIRS") || Quickshell.env("FEDORY_IMAGE_SELECTOR_DIR") || Quickshell.env("FEDORY_STOCK_BACKGROUNDS_DIR") || (stateHome + "/fedory/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("FEDORY_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("FEDORY_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("FEDORY_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return fedoryPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by fedory-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "fedory-image-selector"
